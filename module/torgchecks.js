...
export function PossibilityCheck () {
   ...
   close: html => {
    if (applyChanges) {
     ...
     var messageContent1 = '<p style="text-align:center;font-weight:bold">Possibility Roll</p>' + '<p>' + 'Previous Roll Total: ' + previousroll.value + '<p>' + 'Possibility Roll: ' + newroll + '<p>' + 'New Roll Total:' + diceroll + '<p>';
    ...
    var finalMessage= messageContent1 + messageContent
