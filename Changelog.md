...
- Fixes #520 where an error was generated by the player list if no GM is active.
- Fixes #521 for French language status markers.
- Fixes #522 where equipping an armor did not unequip other armour.
...
- Allow **editting Portraits** of Actors and Items by their owner.
